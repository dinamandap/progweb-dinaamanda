...
<body>
    ...
    <div class="col-md-15 p-5 pt-2">
        ...
        <form action="../config/edit-list.php" method="POST" enctype="multipart/form-data">
            <?php
